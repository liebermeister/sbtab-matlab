function  [my_struct,attributes] = sbtab_table_convert_to_simple_struct(my_sbtab_table,column_key,column_value)
...
[dum,attributes] = sbtab_table_convert_to_struct(my_sbtab_table);
